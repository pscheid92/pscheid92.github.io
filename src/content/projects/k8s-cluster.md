...
language: YAML
kind: Infrastructure
topics: [kubernetes, k3s, fluxcd, gitops, envoy-gateway, cert-manager, kafka, scylladb, zitadel]
---
...
- **Operators over manual management** — CloudNativePG, Dragonfly, Strimzi, and ScyllaDB operators handle the lifecycle of stateful workloads that I don't want to manage by hand.
...
## Tech Stack
 ...
 - **Data:** CloudNativePG (PostgreSQL 17/18), Dragonfly Operator, Strimzi (Kafka 4.2.0), ScyllaDB Operator
